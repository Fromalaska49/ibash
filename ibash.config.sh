...
load_ibash_module "${ibash_path}/definitions/cd_up.sh"
load_ibash_module "${ibash_path}/definitions/prompt.sh"
load_ibash_module "${ibash_path}/definitions/help.sh"
load_ibash_module "${ibash_path}/definitions/extract.sh"
